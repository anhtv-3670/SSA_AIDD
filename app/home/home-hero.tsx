...
import { formatEventDate } from "@/lib/event-config";
...
// Countdown is now LIVE (<HomeCountdown/>) reusing the F008 engine; event date from event-config.
// CTAs navigate: ABOUT AWARDS → /he-thong-giai, ABOUT KUDOS → /sun-kudos.
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          {/* mms_B1_Countdown — live countdown (HomeCountdown) */}
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: "60px" }}>
              <span>
                ...
                <span style={{ fontFamily: "Montserrat, sans-serif", fontSize: "24px", fontWeight: 700, color: "#FFEA9E" }}>{formatEventDate()}</span>
              </span>
              <span>
        ...
        {/* mms_B3_Call-To-Action — row gap 40px. CTAs navigate to the real pages. */}
        <div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
          {/* Primary → Award System (/he-thong-giai) — bg #FFEA9E, 276x60px, radius 8px */}
          <Link
            href="/he-thong-giai"
            style={{ width: "276px", height: "60px", backgroundColor: "#FFEA9E", borderRadius: "8px", border: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "16px 24px", cursor: "pointer", fontFamily: "Montserrat, sans-serif", fontSize: "22px", fontWeight: 700, lineHeight: "28px", color: "#00101A", textDecoration: "none" }}
          >
            ABOUT AWARDS
          ...
          {/* Secondary → Sun* Kudos board (/sun-kudos) — outline */}
          <Link
            href="/sun-kudos"
            style={{ height: "60px", backgroundColor: "rgba(255,234,158,.10)", borderRadius: "8px", border: "1px solid #998C5F", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "16px 24px", cursor: "pointer", fontFamily: "Montserrat, sans-serif", fontSize: "22px", fontWeight: 700, lineHeight: "28px", color: "#FFFFFF", textDecoration: "none" }}
          >
            ABOUT KUDOS
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
